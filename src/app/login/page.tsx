  ...
  return (
    <div className="w-full max-w-5xl mx-auto rounded-3xl bg-content1 border border-divider shadow-2xl flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="hidden md:flex md:w-1/2 relative bg-zinc-900 overflow-hidden">
        {/* Background Image */}
        <img 
          src="https://images.unsplash.com/photo-1495195134817-a1a2807fac25?q=80&w=2000&auto=format&fit=crop"
      ...
      <Button
        ...
        variant="outline"
        className="w-full py-2.5 rounded-lg border border-default-200 dark:border-zinc-700 text-default-700 dark:text-default-200 font-medium flex items-center justify-center gap-2 hover:bg-default-50 dark:hover:bg-zinc-800 transition-colors"
        isDisabled={isLoading || isGoogleLoading}
      >
        {isGoogleLoading ? (
          <Loader2 className="h-4 w-4 animate-spin" />
