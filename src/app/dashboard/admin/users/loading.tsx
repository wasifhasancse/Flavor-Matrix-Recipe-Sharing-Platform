          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-default-200 dark:bg-zinc-800 shrink-0" />
                <div className="flex flex-col gap-1.5">
                  <div className="h-4 w-36 bg-default-200 dark:bg-zinc-800 rounded" />
                  <div className="h-3 w-48 bg-default-200 dark:bg-zinc-800 rounded" />
                </div>
              </div>
              <div className="h-5 w-20 bg-default-200 dark:bg-zinc-800 rounded-full" />
              ...
              <div className="h-9 w-28 bg-default-200 dark:bg-zinc-800 rounded-xl" />
            </div>
          ))}
        </div>
      </div>
